...
class RemoteSkillFileAccess(
    ...
    override fun delete(path: String) = unsupported()
    override fun rename(path: String, newPath: String) = unsupported()
    override fun copy(path: String, newPath: String, overwrite: Boolean) = unsupported()
    override fun move(path: String, newPath: String, overwrite: Boolean) = unsupported()
